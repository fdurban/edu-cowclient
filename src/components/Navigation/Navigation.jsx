const Navigation = () => {
	return (
		<>
			<nav className=' w-20 absolute justify-between flex flex-col h-full'>
				<div className='mt-10 mb-10'>
					<a href='#'>
						<img
							src='https://randomuser.me/api/portraits/women/76.jpg'
							className='rounded-full w-12 h-12 mb-3 mx-auto'
						/>
					</a>
					<div className='mt-10'>
						<ul>
							<li className='mb-6'>
								<a href='#'>
									<span>
										<svg
											className='fill-current h-7 w-7 text-gray-300 mx-auto hover:text-green-500 '
											viewBox='0 0 24 24'
											fill='none'
				...
				<div className='mb-4'>
					<a href='#'>
						<span>
							<svg
								className='fill-current h-7 w-7 text-gray-300 mx-auto hover:text-red-500'
								viewBox='0 0 24 24'
								fill='none'
								xmlns='http://www.w3.org/2000/svg'>
								<path
